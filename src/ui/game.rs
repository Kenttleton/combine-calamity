...
impl Plugin for GameOverlayPlugin {
    fn build(&self, app: &mut App) {
        app.add_system_set(SystemSet::on_enter(GameState::Game).with_system(game_overlay_setup))
...
fn game_overlay_setup(mut commands: Commands, asset_server: Res<AssetServer>) {
